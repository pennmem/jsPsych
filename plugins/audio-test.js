...
jsPsych.plugins['audio-test'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    display_element.innerHTML += '<div id="audio-test-question" class="audio-test-question" style="margin: 2em 0em;">'+
      ...
      '<textarea name="#jspsych-free-recall-response" class="task-input" id="recall_box" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></textarea>'+
      '</div>';
